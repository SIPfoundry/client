  ...
  function (localStorage, _, CONFIG) {
    ...
    this.settings = {
      mainMenu: [
        ...
        {
          name: 'Contacts',
          url: 'client/views/rosterlist.html',
          iconClass:  'icon-presence_meeting',
          show: 'true'
        },
        {
          name: 'Conference Bridge',
          url: 'client/views/conference-bridge.html',
        ...
        {
          name: 'Voicemails',
          url: 'client/views/voicemails.html',
        ...
        {
          name: 'My profile',
          url: 'client/views/my-profile.html',
        ...
        {
          name: 'Settings',
          url: 'client/views/settings.html',
        ...
        {
          name: 'Search',
          url: 'client/views/search.html',
          iconClass: 'icon-settings_cogs',
          show: 'false'
        },
        {
          name: 'Chat',
          url: 'client/views/chat.html',
        ...
        {
          name: 'default',
          url: 'client/views/default-right.html',
          iconClass: 'icon-settings_cogs',
          type: 'right',
          show: 'false'
        }
