    ...
    var uniteWeb = angular.module('uw', ['angular-meteor', 'ngAnimate', 'ngSanitize', 'ngCookies', 'ngRoute', 'config', 'emoji', 'underscore', 'LocalStorageModule', 'notify', 'xml', 'dragAndDrop']);
